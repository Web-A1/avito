...
12. Plan-builder (UI) — доработки
   - Автосбор плана: автоматический вызов чтения Excel при старте автосбора, предотвращение конфликтов (disable кнопок на время), отображение времени чтения Excel.
   - Балансировка: опция “по всем товарам” / “только по товарам из Excel”, предупреждение, если цель меньше текущего количества.
   - Сохранение/очистка: аккуратное обновление блокa “Товары” без стирания вручную добавленных задач (добавить режим “перезаписать”).
   - Валидация/подсказки: фиксировать время последнего объявления, подсвечивать уход за окна публикаций.
