...
function normalizeExistingAd(ad = {}) {
  ...
  const map = {
    ...
    category: ad['категория'] || ad['category'],
    goodsType: ad['тип_товара'] || ad['goodstype'],
    goodsSubType: ad['подтип_товара'] || ad['goodssubtype'],
    serviceType: ad['тип_услуги'] || ad['servicetype'],
    serviceSubtype: ad['подтип_услуги'] || ad['servicesubtype'],
    wasteType: ad['тип_мусора'] || ad['wastetype'],
    adType: ad['тип_объявления'] || ad['adtype'],
    condition: ad['состояние'] || ad['condition'],
    delivery: ad['доставка'] || ad['delivery'],
    contactMethod: ad['способ_связи'] || ad['contactmethod'],
    contactPhone: ad['телефон'] || ad['contactphone'],
    email: ad['email'] || ad['e_mail'] || ad['email'],
    managerName: ad['имя_менеджера'] || ad['managername'],
    companyName: ad['название_компании'] || ad['companyname'],
    listingFee: ad['плата_за_размещение'] || ad['listingfee'],
    adStatus: ad['статус_объявления'] || ad['adstatus'],
    internetCalls: ad['интернет_звонки'] || ad['internetcalls'],
    targetAudience: ad['целевая_аудитория'] || ad['targetaudience'],
    sameDayPickup: ad['самовывоз_в_день_обращения'] || ad['samedaypickup'],
    performersOnTheTeam: ad['количество_исполнителей'] || ad['performersontheteam'],
    workExperience: ad['опыт_работы'] || ad['workexperience'],
    workWithLegalEntities: ad['работаем_с_юрлицами'] || ad['workwithlegalentities'],
    workDays: ad['рабочие_дни'] || ad['workdays'],
    workTimeFrom: ad['время_работы_с'] || ad['worktimefrom'],
    workTimeTo: ad['время_работы_до'] || ad['worktimeto'],
    minimumOrderAmount: ad['минимальная_стоимость_заказа'] || ad['minimumorderamount'],
    callsDevices: ad['устройства_для_звонков'] || ad['callsdevices'],
    promo: ad['промо'] || ad['promo'],
    promoAutoOptions: ad['промо_авто_опции'] || ad['promoautooptions'],
    promoManualOptions: ad['промо_ручные_опции'] || ad['promomanualoptions'],
    roomType: ad['тип_помещения'] || ad['roomtype'],
    latitude: ad['широта'] || ad['latitude'],
    longitude: ad['долгота'] || ad['longitude']
  };
  ...
  return {
    ...
    listingFee: map.listingFee,
    adStatus: map.adStatus,
    internetCalls: map.internetCalls,
    targetAudience: map.targetAudience,
    sameDayPickup: map.sameDayPickup,
    performersOnTheTeam: map.performersOnTheTeam,
    workExperience: map.workExperience,
    workWithLegalEntities: map.workWithLegalEntities,
    workDays: map.workDays,
    workTimeFrom: map.workTimeFrom,
    workTimeTo: map.workTimeTo,
    minimumOrderAmount: map.minimumOrderAmount,
    callsDevices: map.callsDevices,
    promo: map.promo,
    promoAutoOptions: map.promoAutoOptions,
    promoManualOptions: map.promoManualOptions,
